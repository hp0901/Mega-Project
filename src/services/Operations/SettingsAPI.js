...
export function updateDisplayPicture(token, formData, profileData = null) {
    ...
    return async (dispatch, getState) => {
        ...
        try {
            ...
            if (!updatedUserDetails) {
                throw new Error("No user details returned from the server.");
            }
            ...
            dispatch(setUser({
                ...currentState,
                ...updatedUserDetails,
                userId: updatedUserDetails.userId || currentState.userId,
